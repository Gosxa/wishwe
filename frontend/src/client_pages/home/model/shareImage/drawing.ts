...
export const FALLBACK_FONT_SANS = 'Arial, sans-serif';
export const FALLBACK_FONT_SERIF = 'Georgia, serif';
...
export const getShareDateParts = (dateText: string) => {
...
export const getWhereLabel = (location: string) => {
...
export const eventTypeLabel = (event: FeedEvent) =>
  event.type === 'plan' ? 'Plan' : 'Wish';

export const watermarkColor = (event: FeedEvent) =>
